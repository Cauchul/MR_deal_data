...
if __name__ == '__main__':
    data_path = r'D:\MrData\0321\20240321\xiaomi_12'
    # find_all_file(data_path)

    # file_a = r'D:\MrData\3月15日\demo\NR_MR_Detail_20240315134928_extension_final_result_4G.csv'
    # file_b = r'D:\MrData\3月15日\demo\NR_MR_Detail_20240315134928_extension_final_result_5G.csv'
    # merge_two_file(file_a, file_b)

    # 获取output目录
    res_file_list = get_output_dir_csv(data_path)
    print(res_file_list)
