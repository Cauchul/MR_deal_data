...
def process_one_piece_data(in_data_path, net_type):
    ...
    # 获取测试时间
    name_d_time = ue_df['pc_time'][0].split(' ')[0]
    ...
    if 'LTE' == net_type:
        ...
        # 处理数据
        res_df_data = WeTestIn.deal_wetest_4g(df_data)
        ...
        df_write_to_csv(df_data, untreated_file)
        nr_res_df = WeTestIn.deal_wetest_5g(df_data)
...
if __name__ == '__main__':
    ...
    # 处理数据
    process_one_piece_data(wetest_indoor_data_path, 'LTE')
