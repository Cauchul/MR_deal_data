...
def copy_zcy_unzip_file(in_path, in_output_path):
...
def deal_char(in_path, in_output_path):
    # 获取配置文件信息
    lon_O, lat_O, len_east_x, len_north_y = read_config_file(in_path)
    # 处理char数据
    char_file = get_file_by_string('-chart', in_output_path)
    ...
    generate_images(res_x1_values, res_y1_values, lon, lat, in_output_path, '_走侧仪')
...
if __name__ == '__main__':
    data_path = r'D:\working\1206_国际财经中心测试V1\场景2\8539\NR\V5'
    unzip_zcy_wifi_data(data_path)
