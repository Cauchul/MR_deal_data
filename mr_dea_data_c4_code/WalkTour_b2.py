...
def deal_walktour_data(in_data_path_list):
    for i_data_path in in_data_path_list:
        ...
        if not ue_df['Network Type'].empty:
            ...
            file_name = f'{net_type}_{name_are}_{name_scenario}_{name_test_dev}_{name_test_type}_{name_ue}_{name_d_time}_{p_list[-4]}_{p_list[-3]}_{p_list[-2]}_WT_LOG_DT_UE_{p_list[-1]}'
