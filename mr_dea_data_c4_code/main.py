# -*- coding: utf-8 -*-
from Common import get_all_data_path, check_path
from WalkTour import deal_walktour_data
from deal_zcy_data import unzip_and_deal_zcy
from merge_h_v_data import merge_res_file
from merge_res_h_v_file import clear_merge_path
# 输出路径
...
# 合并ue、zcy数据，生成标准文件
deal_walktour_data(data_path_list, test_area)

# 合并输出横纵数据, in_clear_flag 表示是否清理中间数据，如果为true表示清理
merge_res_file(out_data_path, in_clear_flag=True)
