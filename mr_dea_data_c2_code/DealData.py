...
class DealData:
    ...
    @staticmethod
    def deal_WalkTour_indoor_4g(log_df_4g, set_scene_data):
        # 删除测试log中 秒级重复数据，同秒取第一条。
    ...
    @staticmethod
    def deal_WalkTour_indoor_5g(log_df_5g, set_scene_data):
        # 删除测试log中 秒级重复数据，同秒取第一条
        ...
        log_df_5g['pc_time'] = log_df_5g['f_time']
    ...
    # @staticmethod
    # def deal_WalkTour_indoor_5g(log_df_5g, in_f_msisdn, set_scene_data):
    #     # 删除测试log中 秒级重复数据，同秒取第一条
    ...
    #                    'f_rsrq_n3', 'f_sinr_n3', 'f_rsrp_n4', 'f_rsrq_n4', 'f_sinr_n4', 'f_rsrp_n5', 'f_rsrq_n5',
    #                    'f_sinr_n5',
    #                    'f_rsrq_n6', 'f_sinr_n6', 'f_rsrp_n7', 'f_rsrq_n7', 'f_sinr_n7', 'f_rsrp_n8',
    #                    'f_rsrq_n8', 'f_sinr_n8', 'f_year', 'f_month', 'f_day', 'pc_time', 'f_x', 'f_y',
    #                    'f_sid', 'f_pid', 'f_direction', 'f_source', 'f_device_brand',
    #                    'f_device_model']
    #     log_df_5g = log_df_5g.reindex(columns=new_columns)
