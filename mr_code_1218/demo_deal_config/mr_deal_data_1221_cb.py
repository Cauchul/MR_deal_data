...
class DealUEMR:
    ...
    def deal_UEMR_4g(log_df_4g):
        ...
        # 删除测试log中 秒级重复数据，同秒取第一条。
        # log_df_4g = Common.delete_df_duplicate_data_by_second(log_df_4g, log_df_4g['f_time'])
    ...
    def deal_UEMR_5g(log_df_5g):
        ...
        # 删除测试log中 秒级重复数据，同秒取第一条。
        log_df_5g = Common.delete_df_duplicate_data_by_second(log_df_5g, log_df_5g['f_time'])
...
class OutDataTableFormat:
    ...
    # WIFIBlueToothDataOut = ['f_province', 'f_city', 'f_district', 'f_street',
    #             'f_building', 'f_floor', 'f_area', 'f_prru_id', 'f_scenario',] + ['f_wifi_name_1', 'f_wifi_mac_1', 'f_wifi_rssi_1',
    #                         'f_wifi_freq_1', 'f_wifi_name_2', 'f_wifi_mac_2', 'f_wifi_rssi_2',
    #                         'f_wifi_freq_2', 'f_wifi_name_3', 'f_wifi_mac_3', 'f_wifi_rssi_3',
    #                         'f_wifi_freq_3', 'f_wifi_name_4',
    #                         'f_wifi_mac_4', 'f_wifi_rssi_4', 'f_wifi_freq_4', 'f_wifi_name_5',
